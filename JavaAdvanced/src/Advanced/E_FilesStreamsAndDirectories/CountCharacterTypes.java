...
public class CountCharacterTypes {
    public static void main(String[] args) {
        ...
        try (FileInputStream fileInputStream = new FileInputStream("src/Advanced.Resources/input.txt")) {
            PrintWriter printWriter = new PrintWriter("src/Advanced.Resources/sumsOutput.txt");
