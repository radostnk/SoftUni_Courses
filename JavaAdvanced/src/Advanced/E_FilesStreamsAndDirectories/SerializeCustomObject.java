...
public class SerializeCustomObject {
    public static void main(String[] args) {
        ...
        try (ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream("src/Advanced.Resources/course.ser"));
             ObjectInputStream objectInputStream = new ObjectInputStream(new FileInputStream("src/Advanced.Resources/course.ser"))) {
